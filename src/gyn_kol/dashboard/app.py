...
with tab_graph:
    ...
    st.info("Network graph visualisation is generated as an HTML file. Run the graph export to view it.")
...
with tab_summary:
    ...
    if clinicians:
        ...
        if "tier" in df.columns:
            ...
            fig_bar = px.bar(x=tier_counts.index.astype(str), y=tier_counts.values, labels={"x": "Tier", "y": "Count"}, title="Clinicians by Tier")
